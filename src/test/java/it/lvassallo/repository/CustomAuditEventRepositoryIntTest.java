...
import it.lvassallo.config.audit.AuditEventConverter;
import it.lvassallo.domain.PersistentAuditEvent;
...
import static it.lvassallo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
