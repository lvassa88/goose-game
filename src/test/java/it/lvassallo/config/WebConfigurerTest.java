...
public class WebConfigurerTest {
	...
	public void testStartUpProdServletContext() throws ServletException {
		...
		assertThat(servletContext.getAttribute(InstrumentedFilter.REGISTRY_ATTRIBUTE)).isEqualTo(null);
		assertThat(servletContext.getAttribute(MetricsServlet.METRICS_REGISTRY)).isEqualTo(null);
